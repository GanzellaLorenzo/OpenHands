"""Tests for BitbucketDCResolverMixin."""
...
def test_mro_includes_resolver_mixin_and_base_git_service():
    ...
    mro_names = [cls.__name__ for cls in BitbucketDataCenterService.__mro__]
    ...
    assert issubclass(BitbucketDataCenterService, BaseGitService)
