...
export enum I18nKey {
  ...
  SETTINGS$USE_MICROVM = "SETTINGS$USE_MICROVM",
  SETTINGS$RUNTIME_TIER = "SETTINGS$RUNTIME_TIER",
  SETTINGS$RUNTIME_TIER_DESCRIPTION = "SETTINGS$RUNTIME_TIER_DESCRIPTION",
