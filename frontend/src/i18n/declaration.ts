...
export enum I18nKey {
  ...
  SETTINGS$NAV_AUTOMATIONS = "SETTINGS$NAV_AUTOMATIONS",
  AUTOMATIONS$EMPTY_STATE = "AUTOMATIONS$EMPTY_STATE",
  AUTOMATIONS$EMPTY_STATE_HINT = "AUTOMATIONS$EMPTY_STATE_HINT",
  AUTOMATIONS$SCHEDULE = "AUTOMATIONS$SCHEDULE",
  AUTOMATIONS$STATUS = "AUTOMATIONS$STATUS",
  AUTOMATIONS$LAST_RUN = "AUTOMATIONS$LAST_RUN",
  AUTOMATIONS$CONFIRM_DELETE = "AUTOMATIONS$CONFIRM_DELETE",
  AUTOMATIONS$DISPATCH_SUCCESS = "AUTOMATIONS$DISPATCH_SUCCESS",
  AUTOMATIONS$DISPATCH_ERROR = "AUTOMATIONS$DISPATCH_ERROR",
  AUTOMATIONS$RUNS_TITLE = "AUTOMATIONS$RUNS_TITLE",
  AUTOMATIONS$TOTAL_RUNS = "AUTOMATIONS$TOTAL_RUNS",
  AUTOMATIONS$LOADING_RUNS = "AUTOMATIONS$LOADING_RUNS",
  AUTOMATIONS$NO_RUNS = "AUTOMATIONS$NO_RUNS",
  AUTOMATIONS$COL_STATUS = "AUTOMATIONS$COL_STATUS",
  AUTOMATIONS$COL_CREATED = "AUTOMATIONS$COL_CREATED",
  AUTOMATIONS$COL_STARTED = "AUTOMATIONS$COL_STARTED",
  AUTOMATIONS$COL_DURATION = "AUTOMATIONS$COL_DURATION",
  AUTOMATIONS$COL_DETAILS = "AUTOMATIONS$COL_DETAILS",
  AUTOMATIONS$VIEW_CONVERSATION = "AUTOMATIONS$VIEW_CONVERSATION",
  AUTOMATIONS$NEVER = "AUTOMATIONS$NEVER",
  AUTOMATIONS$ENABLED = "AUTOMATIONS$ENABLED",
  AUTOMATIONS$DISABLED = "AUTOMATIONS$DISABLED",
  AUTOMATIONS$CLICK_TO_DISABLE = "AUTOMATIONS$CLICK_TO_DISABLE",
  AUTOMATIONS$CLICK_TO_ENABLE = "AUTOMATIONS$CLICK_TO_ENABLE",
  AUTOMATIONS$RUN_NOW = "AUTOMATIONS$RUN_NOW",
  AUTOMATIONS$VIEW_RUNS = "AUTOMATIONS$VIEW_RUNS",
  AUTOMATIONS$DELETE = "AUTOMATIONS$DELETE",
  AUTOMATIONS$BACK_TO_LIST = "AUTOMATIONS$BACK_TO_LIST",
}
